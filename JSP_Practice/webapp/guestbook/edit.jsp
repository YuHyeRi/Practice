...
<script>
	function gb_update() {
		...
		document.form1.action = "/jsp02/guestbook_servlet/update.do";
	...
	function gb_delete() {
		...
		if(result) {
			document.form1.action = "/jsp02/guestbook_servlet/delete.do";
			document.form1.submit();
		}
	}
</script>
...
<body>
	<h2>방명록 편집</h2>
		...
		<tr>
			<td style="text-align:center; background-color:salmon">이름</td>
		...
		<tr>
			<td style="text-align:center; background-color:salmon">비밀번호</td>
		...
		<tr align="center">
			<td colspan="2">
				...
				<input type="button" value="목록" onclick="location.href='/jsp02/guestbook_servlet/list.do'">
			</td>
		</tr>
	</table>
	</form>
